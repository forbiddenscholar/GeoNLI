...
def main():
    image_path = "https://img.sanishtech.com/u/bb99f0a5fd3482806452f34af51fcbf4.png"
    ...
    # binary = binary_ans(image_path, image_type, "Answer in yes or no. Is there a airplane present in the image?")
    # print(binary)
    
    # count = counting_ans(image_path, image_type, "how many care are there in the image")
    # print(count)
    
    # semantic = semantic_ans(image_path, image_type, "Where are the cars in the image")
    # print(semantic)
    
    ground = grounding(image_path, image_type, "locate and return the bounding boxes for swimming pools in the image")                  
    print(ground)
